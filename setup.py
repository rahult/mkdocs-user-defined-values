...
https://github.com/rahult/mkdocs-user-defined-values
...
setup(
    ...
    #
    # And where it will live on PyPI: https://pypi.org/project/mkdocs-user-defined-values/
    #
    # There are some restrictions on what makes a valid project name
    # specification here:
    # https://packaging.python.org/specifications/core-metadata/#name
    name="mkdocs-user-defined-values",  # Required
    ...
    description="Enable user defined values for MkDocs",  # Optional
    ...
    url="https://github.com/rahult/mkdocs-user-defined-values",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Rahul Trikha",  # Optional
    ...
    keywords="mkdocs plugin user defined value",  # Optional
    ...
    # syntax, for example:
    #
    #   $ pip install mkdocs-user-defined-values[dev]
    #
